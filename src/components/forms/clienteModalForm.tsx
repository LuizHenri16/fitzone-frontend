...
export const ClienteModalForm: React.FC<ModalProps> = ({ isOpen = false, onClose }) => {
    ...
    return (
        <div>
            <div className="fixed inset-0 z-100 flex items-center px-5 justify-center bg-black/50 backdrop-blur-sm">
                    ...
                    >
                        {({ isSubmitting }) => (
                            <Form className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                ...
                                <div>
                                    <TextField label="Endereço" name="endereco" theme="lined" placeholder="Digite o endereço do aluno" type="text" />
                                    <ErrorMessageAlert name="endereco" component="div" />
                                </div>
                                ...
                                {/* Histórico e matrícula ocupando toda a largura */}
