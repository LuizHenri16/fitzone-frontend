                    ...
                    <div className="fixed inset-0 z-50 flex items-center px-5 justify-center bg-black/50 backdrop-blur-sm">
                        <div className="w-full max-w-[50rem] bg-[#F3F3F3] rounded-2xl shadow-2xl px-6 py-8 max-h-[90vh] overflow-y-auto">
                            ...
                            <Formik
                                initialValues={
                                    {
                                        name: alunoEditar?.name, cpf: alunoEditar?.cpf, dataNascimento: alunoEditar?.dataNascimento,
                                        telefone: alunoEditar?.telefone, telefoneEmergencia: alunoEditar?.telefoneEmergencia, email: alunoEditar?.email,
                                        endereco: alunoEditar?.endereco, peso: alunoEditar?.peso, altura: alunoEditar?.altura, historicoSaude: alunoEditar?.historicoSaude,
                                        matricula: alunoEditar?.matricula
                                    }}
                                validationSchema={
                                    Yup.object(
                                        {
